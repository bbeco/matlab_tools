...
resultsDir = fullfile('../results/densification_test/densification8');
...
color1 = imread(fullfile(baseDir, 'imgR.png'));
color2 = imread(fullfile(baseDir, 'imgL.png'));

gray1 = rgb2gray(color1);
gray2 = rgb2gray(color2);

loc1 = groundTruthPoses.Location{2};
orient1 = groundTruthPoses.Orientation{2};

loc2 = groundTruthPoses.Location{1};
orient2 = groundTruthPoses.Orientation{1};
