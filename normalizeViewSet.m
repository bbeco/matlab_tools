...
function [vSet, groundTruth] = normalizeViewSet(vSet, groundTruth)
...
% Rotate the ground truth too (if needed)
R = groundTruth.Orientation{1}';
for i = 1:height(groundTruth)
	groundTruth.Orientation{i} = groundTruth.Orientation{i} * R;
end
