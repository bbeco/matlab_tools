function reconstructing_function(xyzPoints, poses, usedFrames, baseDir, resultsDir)
...
% Sparse point cloud
sparsePoints{1, 1} = xyzPoints{1, 1};
...
for i = firstIndex:(lastIndex - viewStep)
