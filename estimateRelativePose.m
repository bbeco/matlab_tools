...
% debug...
	index = frontIndex1 & frontIndex2;
	matchedPoints1 = matchedPoints1(index, :);
	matchedPoints2 = matchedPoints2(index, :);
...
for i = 1:100
	...
	% Take front points only (for both point sets)
	%inlierIdx = inlierIdx(frontIndex1 & frontIndex2);
